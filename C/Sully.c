...
int	main()
{
	...
	if (i > 0)
	{
		...
		if ((fd = open(f, FLAGS, MODE)) < 0)
			return (2);
		dprintf(fd, QUINE, 10, 10, 10, 34, 34, 10, 10, 10, 34, QUINE, 34, 10, 10, 9, 10, 10, 9, 42, 42, 42, 10, 9, 10, 10, 9, --i, 10, 9, 10, 9, 10, 9, 9, 10, 9, 9, 9, 10, 9, 9, 34, 34, 10, 9, 9, 9, 10, 9, 9, 10, 9, 9, 9, 10, 9, 9, 10, 9, 9, 34, 34, 10, 9, 9, 10, 9, 10, 9, 10, 10);
